...
public class EnumTypesExamples {
	...
	public enum ScienceSchool {CHEM,ORC,ENG,ECS}
	public enum SotonFaculty {FEPS,FAH,FELS,FM, FSS}
	public static void main(String[] args) {



		ScienceSchool x=ScienceSchool.ORC;
		ScienceSchool y=ScienceSchool.ENG;
